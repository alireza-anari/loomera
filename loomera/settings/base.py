...
BALE_POLLING_TIMEOUT_SECONDS = env.int(
    "BALE_POLLING_TIMEOUT_SECONDS", default=0
)
BALE_POLLING_LOCK_TTL_SECONDS = env.int(
    "BALE_POLLING_LOCK_TTL_SECONDS", default=120
)
