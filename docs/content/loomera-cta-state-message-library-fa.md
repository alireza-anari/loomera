...
**Preferred:** `پرداخت کامل نشد. مبلغی کسر نشده است.`  
...
- **Long format:** payment result، modal، support status، security notice  
  مثال: `پرداخت کامل نشد. مبلغی کسر نشده است. لطفاً دوباره تلاش کنید.`
...
- **Body:** `رزرو نهایی نشد. مبلغی کسر نشده است. لطفاً دوباره تلاش کنید یا روش دیگری را انتخاب کنید.`
...
2. پرداخت کامل نشد. مبلغی کسر نشده است. لطفاً دوباره تلاش کنید.
...
- error: `پرداخت کامل نشد. مبلغی کسر نشده است. لطفاً دوباره تلاش کنید.`
